const weekData = [
  {
    ...
    leftSide: {
      oversigt: [
        ...
        "Jeg har også læst i relevante kapitler fra Sketching User Experiences af Bill Buxton, specifikt kapitel 1-3, som omhandler værdien af skitsering i designprocessen. Dette har styrket min forståelse af, hvordan skitser kan fungere som et værktøj til hurtig udforskning og visualisering af koncepter.",
      ],
      udfordringer: [
    ...
    rightSide: {
      ...
      faerdigheder: [
        "I arbejdet med hurtigt at generere flere skitser har jeg udviklet mine færdigheder i at skitsere forskellige UI-layouter og navigationsstrukturer, hvilket har gjort det muligt for mig at evaluere og kritisk vurdere dem. Ved at variere designet af centrale UI-komponenter har jeg eksperimenteret med forskellige tilgange for at identificere de mest brugervenlige og æstetiske løsninger. Jeg har anvendt digitale værktøjer som Figma til at oprette og organisere mine skitser, hvilket har givet mig mulighed for at gemme dem til senere brug og feedback.",
      ],
      kompetencer: [
